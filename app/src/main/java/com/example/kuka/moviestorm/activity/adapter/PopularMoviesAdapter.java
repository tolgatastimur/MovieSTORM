...
public class PopularMoviesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private RecyclerView.ViewHolder getViewHolder(ViewGroup parent, LayoutInflater inflater) {
        ...
        View v1 = inflater.inflate(R.layout.row_popular_movies, parent, false);
        ...
        switch (getItemViewType(position)) {
            case ITEM:
                ...
                Picasso.get()
                        ...
                        .resize(350, 480)
                        .into(((MovieVH) holder).moviePopularImage);

                ((MovieVH) holder).moviePopularImage.setOnClickListener(new View.OnClickListener() {
                    @Override
