...
public class VizyonAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public VizyonAdapter(Context context) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        switch (getItemViewType(position)) {
            case ITEM:
                ...
                ((MovieVH) holder).movieReleaseDate.setText("Yayın Tarihi: " + article.releaseDate);
