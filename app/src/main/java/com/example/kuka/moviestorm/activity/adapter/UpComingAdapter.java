...
public class UpComingAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private RecyclerView.ViewHolder getViewHolder(ViewGroup parent, LayoutInflater inflater) {
        ...
        View v1 = inflater.inflate(R.layout.row_upcoming, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        switch (getItemViewType(position)) {
            case ITEM:
                ...
                ((MovieVH) holder).movieUpComingReleaseDate.setText("Yayın Tarihi: "+article.releaseDate);

                Picasso.get()
                        .load("https://image.tmdb.org/t/p/w500/" + article.posterPath)
                        .resize(350, 480)
                        .into(((MovieVH) holder).movieUpComingImage);

                ((MovieVH) holder).movieUpComingImage.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        MainActivity.activity.setNewFragment(MovieDetailFragment.newInstance(article), R.id.contentFL, "MovieDetailFragment", true, false, false, false);
                    }
                });
                break;
...
//                Do nothing
    ...
    */
    ...
    protected class MovieVH extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.movieUpComingImage)
        ImageView movieUpComingImage;
        @BindView(R.id.movieUpComingReleaseDate)
